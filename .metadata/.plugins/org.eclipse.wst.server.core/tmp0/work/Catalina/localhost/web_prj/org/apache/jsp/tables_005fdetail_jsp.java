 ...
 * Generated at: 2024-05-27 06:21:58 UTC
...
//객체로부터 댓글 목록을 가져와 rlist 변수에 저장합니다.
...
if (rlist != null) { // 댓글 목록이 null이 아닌 경우에만 처리
    for(ReplyVO rvo : rlist) {
      ...
      out.write("\r\n");
      out.write("        <!-- 여기 %seq는 댓글seq다. -->\r\n");
      out.write("        <tr>\r\n");
      out.write("            <td>\r\n");
      out.write("            <!-- \r\n");
      out.write("            삭제 링크를 생성!\r\n");
      out.write("            이 링크를 클릭하면 BoardServlet의 pagecode가 B005로 설정되며, \r\n");
      out.write("            현재 게시물의 seq와 댓글의 rseq가 파라미터로 전달됩니다.\r\n");
      out.write("             -->\r\n");
      out.write("                <font color=red><a href=\"/BoardServlet?pagecode=B005&seq=");
      out.print(bvo.getSeq());
      out.write("&rseq=");
      out.print(rseq);
      out.write("\">[X]</a>\r\n");
      ...
      out.write("				$(\"#boardForm\").attr(\"action\",\"/BoardServlet?pagecode=B003\");\r\n");
      ...
      out.write("				alert(\"삭제\");\r\n");
      out.write("				$(\"#boardForm\").attr(\"method\",\"post\");\r\n");
      out.write("				$(\"#boardForm\").attr(\"action\",\"/BoardServlet?pagecode=B004\");\r\n");
      out.write("				$(\"#boardForm\").submit();\r\n");
      out.write("				return true;\r\n");
      out.write("			});\r\n");
      out.write("			$(\"#listButton\").click(  function(){\r\n");
      out.write("				location.href = \"/BoardServlet?pagecode=B001\";\r\n");
      out.write("			});            \r\n");
      out.write("			\r\n");
      out.write("			//------------------------------------------------------------\r\n");
      out.write("			\r\n");
