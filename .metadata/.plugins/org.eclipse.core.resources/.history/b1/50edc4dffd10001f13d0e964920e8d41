...
public class 복합컬렉션 {
	...
	public static void main(String[] args) {
		 ...
		 * // --------------------------------------- // ArrayList(HashMap) //
		 * --------------------------------------- // {seq="1", title="제목1",
		 * rdate="2024-01-01", regid="kim"} // {seq="2", title="제목2",
		 * rdate="2024-01-01", regid="kim2"}
		 */
		 ...
		 * 
		 * ArrayList<String> arr = new ArrayList<String>(); arr.add("1"); //{"1", "제목1",
		 * "2024-01-01","kim", } arr.add("제목1"); arr.add("2024-01-01"); arr.add("kim");
		 * list.add(arr);
		 * 
		 * ArrayList<String> arr2 = new ArrayList<String>(); arr2.add("2"); //{"1",
		 * "제목1", "2024-01-01","kim"} arr2.add("제목2"); arr2.add("2024-02-02");
		 * arr2.add("kim2"); list.add(arr2);
		 */
		// ArrayList< ArrayList<String> > list = new ArrayList<ArrayList<String>>();
		// //이후에 DB에서 데이터를 가져오는 형태로 변경
		// for (int i=0; i<4; i++) {
