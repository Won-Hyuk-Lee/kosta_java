...
천단위콤마 : <fmt:formatNumber value = "${mynum }" type="currency" currencySymbol="\\"/><br>

소수점 자리수 고정 표기 : <fmt:formatNumber value="${mynum}" type="number" minFractionDigits="2" maxFractionDigits="2"/>
